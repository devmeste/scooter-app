...
public class AuthController implements IAuthController{
	...
	@Override
	public ResponseEntity<HttpStatus> registerSpecialUser(SpecialUserCreateDto specialUser) {
		LOG.info("Register special user: {}", specialUser.toString());
		
		this.authService.registerSpecialUser(specialUser);
