...
public class UserControllerTest {
	...
	public void getAllTest() throws Exception {
		...
		users.add(UserDto.builder().id(34037899L).username("meste73").firstname("Ezequiel").surname("Mestelan").build());
		users.add(UserDto.builder().id(34242399L).username("eljebu").firstname("Jesus").surname("Diaz").build());
	...
	public void getByIdTest() throws Exception {
		...
		UserDto user = UserDto.builder().id(34037899L).username("meste73").firstname("Ezequiel").surname("Mestelan").build();
	...
	public void createTest() throws Exception{
		String requestBody = "{\"id\":34037899,\"username\":\"meste73\",\"cellphone\":2494380393,\"email\": \"elmeste.88@gmail.com\",\"firstname\":\"Ezequiel\",\"surname\":\"Mestelan\"}";
	...
	public void updateTest() throws Exception{
		String requestBody = "{\"id\":34037899,\"username\":\"meste\",\"cellphone\":2494380393,\"email\": \"elmeste.88@gmail.com\",\"firstname\":\"Ezequiel\",\"surname\":\"Mestelan\"}";
